...
def parse_args():
    ...
    parser.add_argument('-dn', '--dataset_name', type=str, default='ml-1m', help='Dataset') # ml-1m, steam, lastfm, citeulike-a
    ...
    parser.add_argument('--enc_module_name', type=str, default='layers.0.weight', help='Name of encoder module to protect')
    parser.add_argument('--dec_module_name', type=str, default='layers.3.weight', help='Name of decoder module to protect')
