...
def parse_args():
    ...
    parser.add_argument('--enc_module_name', type=str, default='encoder.fc1.weight', help='Name of encoder module to protect')
    parser.add_argument('--dec_module_name', type=str, default='decoder.weight', help='Name of decoder module to protect')
