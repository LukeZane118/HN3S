...
def parse_args():
    ...
    parser.add_argument('--enc_module_name', type=str, default='q_layers.0.weight', help='Name of encoder module to protect')
    parser.add_argument('--dec_module_name', type=str, default='p_layers.1.weight', help='Name of decoder module to protect')
