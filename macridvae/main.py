...
def parse_args():
    ...
    parser.add_argument('-mn', '--model_name', type=str, default='macridvae', help='Model name')
    parser.add_argument('-dn', '--dataset_name', type=str, default='ml-1m', help='Dataset') # ml-1m, steam, lastfm
    ...
    parser.add_argument('--kfac', type=int, default=2, help='Number of facets (macro concepts)')
    parser.add_argument('-nogb', default=False, help='Disable Gumbel-Softmax sampling', action='store_true')
    parser.add_argument('--std', type=float, default=0.01, help='Standard deviation of the Gaussian prior')
    parser.add_argument('--temp', type=float, default=0.1, help='Temperature of sigmoid/softmax')
    parser.add_argument('--reg_weights', type=float, nargs='+', default=[0.0, 0.0], help='List of L2 regularization weights')
    ...
    parser.add_argument('--enc_module_name', type=str, default='encoder.0.weight', help='Name of encoder module to protect')
    parser.add_argument('--dec_module_name', type=str, default='item_embedding.weight', help='Name of decoder module to protect')
    
    # attack setting
    parser.add_argument('--restore_epochs', type=int, nargs='*', default=[1, 11, 21, 31, 41], help='Epochs to restore user behaviors')
